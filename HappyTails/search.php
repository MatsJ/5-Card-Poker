...
if(isset($_POST['search'])) {	
    if(isset($_POST['serviceAnimal'])) {
        $service = 'yes';
    } else {
        $service = '';
    }

    $newsearch = new Search($_POST['type'],
                            $_POST['breed'], 
                            $_POST['sex'],
                            $_POST['age'],                         
                            $_POST['size'], 
    ...
    $result = $newsearch->searchFilter($conn);
...
<html lang="en">
    ...
    <div id="carousel-divider"></div>
        ...
        <!-- SEARCH RESULTS -->
        <?php
        echo '<div class="textured-background">
                <div class="container marketing"> 
                   <div class="row" style="border-bottom: 2px solid #cccccc">
                       ...
                       <div class="col-sm-6">
                           <h3 align="center" style="font-family: \'Fredericka the Great\' , cursive; color: #b90504; font-size: 30pt">Search Results</h3>
                       </div>
                       <div class="col-sm-3 text-right">
                           Showing ' .  count($result) . ' results.   
                       </div>
                   </div>';
        ...
        foreach($result as $pet) {
            ...
            if($media = MediaExtractor::getMedia($conn, $pet['animal_id'], 'image')) {
                $data = @MediaExtractor::getThumbnail($media, 400, 280); 
            }
           
            //print_r($media['filename']);
            echo'
                ...
                <div class="row" style="background-color: #f6f6f6; border-radius: 15px">
                    ...
                    <div class="col-lg-5">
                        <br>
                        <img style="margin-left: 15px; max-height: 400px; max-width: 400px" class="img-rounded shadow" src="data:'. "{$media['filetype']}" . ';base64,'.base64_encode($data).'" width="100%" height="100%"/>
                        <br>
                        <br>
                    </div>
                    <div class="col-lg-2">
                        <div>
                            <p style="float: right; font-size: 18pt">Name:</p>
                        </div>
                        <div>
                            <p style="float: right; font-size: 18pt">Summary:</p>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div>
                            <p style="font-size: 18pt; text-align: justify">' . "{$pet['name']}" . '</p>
                        </div>
                        <div>
                            <p style="font-size: 14pt; text-align: justify; margin-top: 15px">' . "{$pet['description']}" . '</p>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                        <div style="margin-right: 40px; margin-bottom: 15px" class="pull-right adopt-button">
                            <a href="contact.php?animal_id=' . "{$pet['animal_id']} " . '">Adopt Me</a>
                        </div>
                        <div style="margin-right: 40px; margin-bottom: 15px" class="pull-right adopt-button">
                            <a href="pet-profile.php?animal_id=' . "{$pet['animal_id']} " . '">Read More</a>
                        </div>
                        <br>
                    </div>
                </div>';
